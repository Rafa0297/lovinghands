...
import db, { User } from '../../data/index.js'
...
describe('registerUser', () => {
  ...
  it('succeds on new user', async () => {
    ...
    expect(user.telephone).to.equal('+34123123123')
  ...
  it('fails on existing user', () =>
    expect(
      (async () => {
        await registerUser(undefined, 'casi@miro.com', '123123123', '123123123', '+34123123123')
      })()
  ...
  it('fails on existing email', () =>
    expect(
      (async () => {
        await registerUser('Seño Rito', undefined, '123123123', '123123123', '+34123123123')
      })()
  ...
  it('fails when passwords do not match', () =>
    expect(
      (async () => {
        await registerUser('Seño Rito', 'seño@rito.com', '123123124', '123123123', '+34123123123')
      })()
